...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/student/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/student/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/student/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/catkin_ws/install/${idir}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/catkin_ws/install/lib;/home/student/catkin_ws/devel/lib;/opt/ros/indigo/lib)
