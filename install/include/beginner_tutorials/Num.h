...
struct MD5Sum< ::beginner_tutorials::Num_<ContainerAllocator> >
{
  ...
  {
    return "0ed0e441a5dffe01ff09c9c4a11925c0";
  }

  static const char* value(const ::beginner_tutorials::Num_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0ed0e441a5dffe01ULL;
  static const uint64_t static_value2 = 0xff09c9c4a11925c0ULL;
};
